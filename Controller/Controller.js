...
const value1 = req.body.value;
  ...
  const rawtx1 = {
   ...
   const sign1 = await web3eth.eth.accounts.signTransaction(rawtx1,privatekey);
   const receipt1 = await web3eth.eth.sendSignedTransaction(sign.rawTransaction);
...
const transfer =  async (req,res) => {
  ...
  // "fc92fef1130ce4e041b39bfaea9053e66cfa4f34462ebfd49ed9a6863032b8ac";
  const burn1 = await ethContract.methods.burn(add,Transfervalue);
  const burnABI = burn1.encodeABI();
